...
import com.ebremer.rocrate4j.writers.ZipWriter2;
import java.io.File;
...
public class ROCrate {
    ...
    private ROCrate(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Writer destination) {
    ...
    public static void main(String[] args) {
        ROCrate.Builder builder = new ROCrate.Builder(new ZipWriter2(new File("d:\\nlms2\\halcyon\\hi.zip")));
        builder.manifest.setName("this is a test");
        builder.build();
        
        builder = new ROCrate.Builder(new FolderWriter(new File("d:\\nlms2\\halcyon\\hidirect")));
        builder.manifest.setName("this is a test");
        builder.build();
    }
}
